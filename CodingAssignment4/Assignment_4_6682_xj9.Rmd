...
Using `evaluate`, I run through some cross-validation among several some models, `UBCF`, `POPULAR` and `SVDF` perform better (measured by RMSE) than others. Thus, for this assignment, I will use models with parameters,
