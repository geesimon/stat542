...
Using `evaluate`, I run through cross-validation test among all available models and found `UBCF`, `POPULAR` and `SVDF` perform better (measured by RMSE) than others. Thus, for this assignment, I will use models with parameters,

- UBCF: normalize = 'Z-score', method = 'cosine', nn = 5
- SVDF: normalize = 'Z-score'
