...
I take several approaches to pre-process the data.
...
preprocess_data = function(train_data, test_data){
  ...
  # r$train_data = Winsorizing2(r$train_data, c("PID", "Overall_Qual","Overall_Cond",
...
```{r}
train_predict(train_data, test_data, lasso_predict, "mysubmission1.txt")
```

# PART 2

In this part, I use my own lasso implementation to predict the test set.
...
```{r}
start_time = proc.time()
train_mylasso(train_data, test_data, "mysubmission3.txt")
cat("Computing time:", (proc.time() - start_time)[3], "\n")
```
