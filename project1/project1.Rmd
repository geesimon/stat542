...
USELESS_VARIABLES = c("Condition_2", "Utilities", "Street", "Pool_QC")
...
rfModel = randomForest(Sale_Price ~ . - PID, data = train_data, importance = T, ntree=500); 
...
myfit1 = gbm(Sale_Price ~ ., data = train_data, distribution = "gaussian", n.trees = 1000,
