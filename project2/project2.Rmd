...
- Dynamic model: for fold 1 to 6, regression model (tslm) is used. Starting from fold 7, since the training data has more than 2 years of data, STL+ARIMA (method='arima', ic='bic') model is built to make the prediction.
